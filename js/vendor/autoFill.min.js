        ...
        function init(identifier) {
            return {
                    ...
                    if (!self.stopSaving) {
                        ...
                        self.targets.each(function () {
                            ...
                            fieldsToProtect.each(function () {
                                var field = $(this);
                                if ($.inArray(field.attr('id')||field.attr('name'), self.options.excludeFields) !== -1) return true;
                ...
                getProtectedFields: function(target) {
                    return target.find(":input").not(":submit").not(":reset").not(":button").not(":file").not(":password").not($$('[name*="cc_"]'));
                },
                    ...
                    if (!self.stopSaving) {
                        ...
                        self.targets.each(function (index) {
                            ...
                            fieldsToProtect.each(function (index2) {
                                var field = $(this);
                                if ($.inArray(field.attr('id')||field.attr('name'), self.options.excludeFields) !== -1 || field.attr("name") === undefined) return true;
